				...
				<ul class="nav ace-nav">
								...
								<ul class="dropdown-menu dropdown-navbar">
						  		...
						  		<c:choose>
									<c:when test="${divCode == '450000'}">
										<c:set var="urls1" value="${ctx}/index#page/office/task/taskAudit"/>
									</c:when>
									<c:otherwise>
										<c:set var="urls1" value="${ctx}/index#page/office/task/wait"/>
									</c:otherwise>
								</c:choose>
					...
					<li class="blue">
						...
						<ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
							...
							<li class="dropdown-footer">
								<a href="${ctx}/index#page/office/notice/noticeViewList">
									查看所有通知
									<i class="ace-icon fa fa-arrow-right"></i>
								</a>
							</li>
					...
					<li class="blue">
						...
						<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
							...
							<li class="dropdown-footer">
								<a href="${ctx}/index#page/office/message/recvlist">
									查看所有信息
									<i class="ace-icon fa fa-arrow-right"></i>
								</a>
							</li>
					...
					<li class="light-blue">
						...
						<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
						    <li>
								<a data-url="page/profile/profile" href="${ctx}/index#page/profile/profile">
	    ...
	    <div id="sidebar" class="sidebar responsive">
		     ...
		     <div class="sidebar-shortcuts" id="sidebar-shortcuts">
				  <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
						<a data-url="page/desktop" href="${ctx}/nqview#page/desktop" class="btn btn-success" data-rel="tooltip" title="我的工作台" style="display:none">
							<i class="ace-icon fa fa-home"></i>
						</a>
						<a data-url="page/office/notice/noticeViewList" href="${ctx}/nqview#page/office/notice/noticeViewList" class="btn btn-warning" data-rel="tooltip" title="通知信息">
							<i class="ace-icon fa fa-bell"></i>
						</a>
						<!-- #section:basics/sidebar.layout.shortcuts -->
						<a data-url="page/office/message/recvlist" href="${ctx}/nqview#page/office/message/recvlist" class="btn btn-info2" data-rel="tooltip" title="我的短信">
							<i class="ace-icon fa fa-envelope"></i>
						</a>
						<a data-url="page/profile/profile" href="${ctx}/nqview#page/profile/profile"  class="btn btn-purple" data-rel="tooltip" title="我的帐户">
							<i class="ace-icon fa fa-user"></i>
						</a>
						<!-- /section:basics/sidebar.layout.shortcuts -->
				 </div>
		    ...
		    <ul class="nav nav-list">
		        <li style="display:none">
					<a data-url="page/desktop" href="${ctx}/index#page/desktop">
				...
				<li class="open" id="menuLi">
				   <ul class="submenu">
				   		...
				   		<c:forEach var="menuItem" items="${allMenuList}" varStatus="menuIndex">
							...
							<a href="${ctx}/nqview#page${menuItem.resString}" data-url="${ctx}/nqview#page${menuItem.resString}">
				   		...
				   		<!-- 
						<li class="">
						<a href="${ctx}/nqview#page/office/wordtypeinfo/nqlist" data-url="page/office/wordtypeinfo/nqlist">
	...
	function enableAjax() {		
		...
		var ajax_options = {
			 ...
			 'content_url': function(hash) {
				...
				//}
				if(path.match(/nqview/)) {
					return path.replace(/nqview/, hash.replace(/^page\//, ''));
				}
