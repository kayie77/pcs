...
<div class="modal-dialog">
	<div class="modal-content">
      	...
      	<form:form cssClass="form-horizontal" id="groupForm" modelAttribute="group" action="${actionUrl}" method="POST">
      		<div class="modal-body no-padding">      	
				<div class="form-group">
					<label class="col-sm-3 control-label" for="groupName">群组名:<span class="required">*</span></label>
					<div class="col-sm-9 controls">
					    <span>
							<form:input  id="groupName" path="groupName" placeholder="群组名..." required="required"/>
					    </span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label" for="groupDesc">群组说明:</label>
					<div class="col-sm-9 controls">
		    			<form:input  id="groupDesc" path="groupDesc" placeholder="群组说明..." />
					</div>
				</div>
				<div class="form-group">
