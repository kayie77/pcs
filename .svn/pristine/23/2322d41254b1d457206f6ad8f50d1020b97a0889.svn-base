 ...
 * 
 */
public class YunforgeUtils {

	private static Log log = LogFactory.getLog(YunforgeUtils.class);
	...
	public static void copyPropFromBean2Dto(Object pFromObj, Map pToDto) {
		if (pToDto != null) {
			try {
	...
	public static String getString(String str,String strType1,String strType2) {
		try {
			
			return new String(str.getBytes(strType1),strType2);
		} catch(Exception e) {
	...
	public static void main(String[] args) {
		String[] str = split("12,234,456,546",",");
