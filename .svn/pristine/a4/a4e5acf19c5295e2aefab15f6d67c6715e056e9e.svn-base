...
<div class="row">
	<div class="col-xs-12">
		<div class="btn-group" style="display:none">
			<button id="showScoreBtn" type="button" class="btn btn-info btn-blue btn-sm btn-round" data-toggle="modal">
...
function textFormatter (cellvalue, options, rowObject) {
	return "<span style='position:relative;left:20px'>" + cellvalue + "</span>";
}
...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
  jQuery(function($) {
	...
	$(grid_selector).jqGrid({
		 url:'${ctx}/office/task/taskScore/treeList',
		 treeGrid: false,
		 ...
		 mtype: "POST",
		 datatype: 'json',
		 colNames:['ID', '区域名称','报表总数','已填报数','未填报数','按时填报数','迟报数','需重报数','提前上报数','得分统计'],
		 colModel:[
		   		{name:'id',index:'id', hidden:true,key:true,width:20, sorttype:'int', editable: true, sortable:false},
		   		{name:'divName',index:'orgName',width:150, editable:true,formatter:textFormatter, sortable:false},
		   		{name:'reportCount',index:'reportCount',width:100, editable:false, sortable:false},
		   		{name:'upCount',index:'upCount',width:100, editable:true, sortable:false},
		   		{name:'notUpCount',index:'notUpCount',width:100, editable:true, sortable:false},
		   		{name:'normalCount',index:'normalCount',width:100, editable:true, sortable:false},
		   		{name:'lateCount',index:'lateCount',width:100, editable:true, sortable:false},
		   		{name:'downCount',index:'downCount',width:100, editable:true, sortable:false},
		   		{name:'aheadCount',index:'aheadCount',width:100, editable:true, sortable:false},
		   		{name:'score',index:'score',width:100, editable:true, sortable:false}
		 ],
		 jsonReader : {
	            root: "rows",
	            repeatitems: false,
...
function showRow(id){
	window.location.href="${ctx}/index#page/office/task/taskScore/view/"+id;
}
function abc() {
