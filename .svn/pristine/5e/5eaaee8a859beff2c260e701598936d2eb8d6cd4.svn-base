...
<div class="row">
	<div class="col-xs-12">
		<div class="btn-group">
			<button id="editReportRoleBtn" type="button" class="btn btn-info btn-blue btn-sm btn-round" data-toggle="modal">
...
<div id="dicModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
  jQuery(function($) {
	...
	var g=$("a[href$='${ctx}/index#page/office/dicReportManager']");
	...
	$(grid_selector).jqGrid({
		 url:'${ctx}/office/task/listDicReport',
		 datatype: 'JSON',
		 colNames:['ID','报表名称'],
		 colModel:[
...
$(window).triggerHandler('resize.jqGrid');//trigger window resize to make the grid get the correct size
	...
	*/
	...
	$("#editReportRoleBtn").click(function(e){
		var rowId = $(grid_selector).jqGrid('getGridParam','selrow');
		if(rowId){
			$.get("${ctx}/office/task/dicReport/"+rowId+"/?"+Math.random(1000) , '', function(data){
	    		var modal = $('#dicModal');
	    		modal.html(data);
