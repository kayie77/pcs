...
public class JCaptchaValidateFilter extends AccessControlFilter {
	...
	protected boolean isAccessAllowed(ServletRequest request,
		...
		log.info("方法:" + httpServletRequest.getMethod());
