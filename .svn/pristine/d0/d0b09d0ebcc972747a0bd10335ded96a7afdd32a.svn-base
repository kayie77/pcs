				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"> 
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<!-- <div class="user-info"  style="display: block;float: left;height: 40px;line-height: 40px">
	    ...
	    <div id="sidebar" class="sidebar responsive">
		     ...
		     <div class="sidebar-shortcuts" id="sidebar-shortcuts">
				  <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
						<a data-url="page/desktop" href="${ctx}/index#page/desktop" class="btn btn-success" data-rel="tooltip" title="我的工作台">
							<i class="ace-icon fa fa-home"></i>
						</a>
						<a data-url="page/office/notice/noticeViewList" href="${ctx}/index#page/office/notice/noticeViewList" class="btn btn-warning" data-rel="tooltip" title="通知信息">
							<i class="ace-icon fa fa-bell"></i>
						</a>
						<!-- #section:basics/sidebar.layout.shortcuts -->
						<a data-url="page/office/message/recvlist" href="${ctx}/index#page/office/message/recvlist" class="btn btn-info" data-rel="tooltip" title="我的短信">
							<i class="ace-icon fa fa-envelope"></i>
						</a>
						<a data-url="page/profile/profile" href="${ctx}/index#page/profile/profile"  class="btn btn-purple" data-rel="tooltip" title="我的帐户">
							<i class="ace-icon fa fa-user"></i>
						</a>
						<!-- /section:basics/sidebar.layout.shortcuts -->
				 </div>
...
jQuery(function($) {
	...
	function enableAjax() {		
		...
		var ajax_options = {
			 ...
			 'default_url': 'page/desktop',//default hash
