...
<div class="row">
	<div class="col-xs-12">
		<div class="btn-group">
			<button id="showAuditReportBtn" type="button" class="btn btn-info btn-blue btn-sm btn-round" data-toggle="modal">
				<i class="fa fa-eye"></i>   
				查看
			</button>
		</div>
...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
  jQuery(function($) {
	...
	var g=$("a[href$='${ctx}/index#page/office/task/auditReport']");
...
$(window).triggerHandler('resize.jqGrid');//trigger window resize to make the grid get the correct size
	...
	*/
	...
	$("#showAuditReportBtn").click(function(e){
		var rowId = $(grid_selector).jqGrid('getGridParam','selrow');
		if(rowId){
			$.ajax({
		  		type : 'GET',
		  	    dataType : 'JSON',
		  		url : '${ctx}/office/task/viewAuditReport/'+id,
