...
<body>
	<div class="row" style="background: #fff;">
				...
				<header>
					<div id="fdw-pricing-table">
						...
						<div class="container-fluid">
							<div class="row" style="padding:0px 25px 25px 25px;text-align:left;">
						      <div class="widget-box">
						        <div class="widget-header widget-header-flat">
						          <h4 class="widget-title">历史明细查询</h4>
						        </div>
						
						        <div class="widget-body">
						          <div class="widget-main">
									      <div class="" style="margin-bottom:10px;">
						  		        <form class="form-inline" id="searchForm" action="${ctx}/collect/querySelfHistoryDetail" >
		...
		function reloadTakMainTable(){
	        ajaxRenderTable('${ctx}/collect/querySelfHistoryDetail?taskMainId=${taskMainId}&reriod=',genRowTemplate());
	        //清空takDetailTable表
	       ...
	       $('#dcpContainer').html('');
			...
			$('#takMainTable').on('click', 'td.row-select,a[name="detail"]', function () {
	            ...
	            var url = '${ctx}/main#page/collect/dataReoprtedDetail/manager?dmId=' + tm_set.attr('id')+"&date="+new Date().getTime();
	            window.open(url);
	        });
			
			function reloadTaskDetailPage(dmId) {
				var url = '${ctx}/main#page/taskMain/selfHistoryDetailManager?taskMainId=' + dmId;
				window.open(url);
				loadPage(url);
			}
		</script>
