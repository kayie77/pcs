...
<sjg:grid dataType="json" href="%{listFund}" pager="true"
	rownumbers="true" navigator="true" navigatorSearch="true"
	navigatorAdd="false" navigatorEdit="false" navigatorView="false"
	navigatorDelete="false" gridModel="fundList" rowList="5,10,15,20"
	rowNum="5" viewrecords="true" height="160" width="860" footerrow="true"
