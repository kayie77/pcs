...
<div class="row">
	<div class="col-xs-12">
		<div class="btn-group">
			<button id="editAuditReportBtn" type="button" class="btn btn-info btn-blue btn-sm btn-round" data-toggle="modal">
...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
  jQuery(function($) {
	...
	var g=$("a[href$='${ctx}/index#page/office/task/auditReportManager']");
	...
	$(grid_selector).jqGrid({
		 url:'${ctx}/office/task/auditManagerlist',
		 datatype: 'JSON',
		 colNames:['ID','报表名称','角色名称'],
		 colModel:[
		   		{name:'id',index:'id', hidden:true,width:100, editable: true},
		   		{name:'auditReportName',index:'auditReportName',width:150,editable: true},
		   		{name:'roleId',index:'roleId',width:150,editable: true}
		 ],
		 jsonReader : {
				root: "rows",
	            page: "page",
	...
	*/
	...
	$("#editAuditReportBtn").click(function(e){
		var rowId = $(grid_selector).jqGrid('getGridParam','selrow');
		if(rowId){
			$.get("${ctx}/office/task/auditReport/"+rowId+"/?"+Math.random(1000) , '', function(data){
