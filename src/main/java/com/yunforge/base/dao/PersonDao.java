...
public interface PersonDao extends JpaRepository<Person, String>,
	...
	@Query("select t from Person t where t.isCollent=?2 and  t.org.id=?1 and t.user.enabled = 1 and t.persName like ?3 ")
	public Page<Person> findByOrgAndCollect(String orgId,Integer isCollect,Pageable pageable,String persNameParam);
}