          ...
          <form action="" class="form-inline">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                ...
                <select name="market" class="t-condition markets-list" data-parent="region1" >
                </select>
              </div>
            </div>
            <div  class="row">
              <div class="form-group col-sm-3">
                <span class="clable">类型选择：</span>
                <input type="radio" name="atime"  value="day" class="date-condition t1-condition" checked="checked" id="date-day"> 日
                <input type="radio" name="atime"  value="day" class="date-condition t1-condition" id="date-day"> 周
