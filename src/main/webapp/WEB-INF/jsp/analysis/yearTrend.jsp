        ...
        <div class="subject">
          ...
          <div class="content">
            ...
            <div class="visual-container">
              <div id="table" class="table-container" data-table="yearTrend_main" data-condition="t-condition">
              </div>
      ...
      function drawTableChart(component) {
        drawMyChart(
          ...
          [
            ...
            {
              name:'mPrice',
              label: $('#region').find('option:selected').text(),
              data: dui_tbl.getDatas(component, 'mPrice')
            },
            {
              name:'rPrice',
              label: $('#market').find('option:selected').text(),
              data: dui_tbl.getDatas(component, 'rPrice')
            }
          ],
          'line1'
        );
