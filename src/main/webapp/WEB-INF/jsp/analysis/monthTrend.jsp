  ...
  <body>
      ...
      <div class="topic">
        ...
        <div class="constraint">
          <form action="" class="form-inline">
            <input id="priceType" name="type" type="hidden" class="t-condition" value="region">
            <div class="row">
              <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <ul name="product" class="t-condition list-inline dui-controller products-list" data-parent="ctg"  data-custom="true"></ul>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-6">
                <span class="clable">地区：</span>
                <select id="region" name="region" class="t-condition region-list" >
                </select>
              </div>
              <div class="col-sm-6">
                <span class="clable">交易地选择：</span>
                <select id="market" name="market" class="t-condition markets-list" data-parent="region" >
                </select>
              </div>
            </div>
            <div  class="row">
              <div class="form-group col-sm-4">
                <span class="clable">月度选择：</span>
              ...
              <div class="form-group col-sm-1">
                <div>
                  <button class="btn btn-default search-btn" data-target="table" type="button">查询</button>
                </div>
              </div>
            </div>
          </form>
        ...
        <div class="subject">
          ...
          <div class="content">
            ...
            <div class="visual-container">
              <div id="table" class="table-container" data-table="monthtrend_main" data-condition="t-condition">
              </div>
    ...
    <script>
      ...
      $(document).ready(function(){
        ...
        .on(
          ...
          function (e, component) {
            if (component.attr('id') == 'tableChart') {
              drawTableChart(component);
            }
          }
        );
      ...
      $('.search-btn').off('click').click(function () {
        if ($('#market').val() == '' || typeof $('#market').val() == undefined) {
          $('#priceType').val('region');
        } else {
          $('#priceType').val('market');
        }
        loadTable($('#' + $(this).data('target')));
      });

      function drawTableChart(component) {
        drawMyChart(
          $('#tableChart'),
          ...
          [
            {
              name:'time',
              label: '时间',
              data: dui_tbl.getDatas(component, 'time')
            },
            {
              name:'time',
              label: '价格',
              data: dui_tbl.getDatas(component, 'price')
            }
          ].concat(items),
          'line1'
        );
