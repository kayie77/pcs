        ...
        <div class="constraint">
          <div class="row">
            <div class="col-sm-12">
              ...
              <ul id="ctg" name="ctg" class="ctg-list list-inline dui-controller"></ul>
            </div>
            <div class="col-sm-12">
              <span class="clable">重点农产品: </span>
              <ul name="products" class="t1-condition list-inline dui-controller multiple products-list" data-parent="ctg"  data-custom="true"></ul>
              </div>
          </div>
          <div class="row">
            <div class="col-sm-3">
              <span class="clable"></span>
            ...
            <div class="col-sm-4">
              ...
              <select name="market" class="t1-condition markets-list" data-parent="region1" >
              </select>
            </div>
          </div>
        </div>
        ...
        <div class="subject">
          ...
          <div class="content">
            ...
            <div class="visual-container">
              <span>同一农产品不同市场价格</span>
              <div id="table1" class="table-container" data-table="priceSale_ps" data-condition="t1-condition">
              </div>
              <div id="table1Chart" class="chart"></div>
            </div>
            <div class="visual-container">
              <span>同一农产品涨跌幅度</span>
              <div id="table2" class="table-container" data-table="priceSale_ps" data-condition="t2-condition">
              </div>
              <div id="table2Chart" class="chart"></div>
            </div>
            <div class="visual-container">
              <span>同一农产品不同市场价格走势</span>
              <div id="table3" class="table-container" data-table="priceSale_ps" data-condition="t3-condition">
              </div>
              <div id="table3Chart" class="chart"></div>
            </div>
          </div>
        </div>
