...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
  jQuery(function($) {
	...
	$(grid_selector).jqGrid({
		 url:'${ctx}/year/list',
		 datatype: 'JSON',
		 colNames:['ID','名称','年份','开始日期','结束日期','初始化','操作'],
		 colModel:[
		   		{name:'id',index:'id', hidden:true,width:20, editable: true},
		   		{name:'yearName',index:'yearName',width:120, editable: true,
		   			searchoptions:{  
                        sopt:["cn"]
                    }
		   		},
		   		{name:'yearNum',index:'yearNum',width:120, editable: true,search:false},
		   		{name:'startDate',index:'startDate',width:200, sortable:false, editable: true,formatter:statusFormatter,search:false},
		   		{name:'endDate',index:'endDate',width:200, sortable:false, editable: true,formatter:statusFormatter,search:false},
		   		{name:'initialized',index:'initialized',editable: true,edittype:'checkbox',editoptions: {value:"true:false"},formatter:'checkbox',width:80,search:false},
	...
	$(grid_selector).jqGrid('navGrid',pager_selector,
	 ...
	 $(grid_selector).jqGrid('navButtonAdd',pager_selector,{
		    caption:"初始化",
		    buttonicon:"ace-icon fa fa-check-circle red",
