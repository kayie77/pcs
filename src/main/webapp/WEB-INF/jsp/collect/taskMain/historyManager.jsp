          ...
          <div class="widget-main">
  		        ...
  		        <form class="form-inline" id="searchForm" action="${ctx}/collect/taskMain" method="get">
  		          <div class="form-group">
  		            ...
  		            <input type="hidden" class="form-control" name="isCheck" value="${param.isCheck}">
...
<div class="loadDiv" id="dcpContainer"></div>
    ...
    var scripts = [
      ...
      function reloadTakMainTable(){
        ajaxRenderTable('${ctx}/collect/queryHistory',genRowTemplate());
        //清空takDetailTable表
...
//           reloadTaskDetailPage(tm_set.attr('id'));
			 window.location.href = "${ctx}/index#page/collect/taskMain/historyDetailManager?taskMainId="+tm_set.attr('id')+"&isCheck=${param.isCheck}&date="+new Date().getTime();
        });
        ...
        function genRowTemplate(node) {
          var tamplate = '<tr id="{id}" class="data-row">' +
                           '<td title="{name}">{name}</td>\
                            ...
                            <a class="green" name="detail"><i class="ace-icon fa fa-cog bigger-150"></i></a>\
                            </div>\
                          </td>\
                          </tr>';
          return tamplate;
