    ...
    <div class="col-xs-2" style="padding:0 2px;">
		<div class="widget-box widget-color-blue2">
			<div class="widget-header">
				<h5 class="widget-title lighter bigger">区域列表</h5>
			</div>
			<div class="widget-body" style="height:700px; overflow-y:scroll;">
  	...
  	jQuery(function($) {
		...
		$("#resTree").jstree({
 			...
 			'core': {
  	  		...
  	  		var divCode = selected.node.a_attr.code;
  	  		if( id != null ) {
  	  			$("#divCode").val(divCode);
   			}
		...
		var g=$("a[href$='${ctx}/index#page/office/task/taskChildren']");
