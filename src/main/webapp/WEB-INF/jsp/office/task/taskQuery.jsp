...
<div class="row">
	<div class="col-xs-12">
		<div class="btn-group" style="display:none">
			<button id="showQueryBtn" type="button" class="btn btn-info btn-blue btn-sm btn-round" data-toggle="modal">
				<i class="fa fa-eye"></i>   
				查看
			</button>
		</div>
...
<input type="hidden" id="divCode" name="divCode" value="${divCode}"/>
...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
  jQuery(function($) {
	...
	$(grid_selector).jqGrid({
		 url:'${ctx}/office/task/querylist',
		 datatype: 'JSON',
		 colNames:['ID','报表'],
		 colModel:[
		   		{name:'id',index:'id', hidden:true,width:100, editable: true},
		   		{name:'reportName',index:'reportName',width:150,editable: true,sortable:false}
		 ],
		 jsonReader : {
				root: "rows",
	            page: "page",
...
/*
function showRow(id){
	window.location.href="${ctx}/index#page/office/task/viewQuery/"+id;
}
*/
