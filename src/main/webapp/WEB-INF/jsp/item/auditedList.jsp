	    ...
	    var selectedIds = jQuery("#"+data.id).jqGrid('getGridParam','selarrrow');
		 ...
		 if (selectedIds!=null && selectedIds.length>0){
			...
			if(filters!="undefined" && filters!=null){
					$.fileDownload('<s:url value="/item/exportApproved.action"/>', { httpMethod : "POST", data: {filters : filters,pageSize:10}});
			}else{
				   $.fileDownload('<s:url value="/item/exportApproved.action"/>', { httpMethod : "POST", data: {pageSize:10}});
			 }
	     }
      });
...
<div class="app-panel">
	<div class="title">当前位置：采购计划 &gt;&gt; 项目查询 &gt;&gt; 已审批项目</div>
	<div class="toolbar">
...
<div id="itemWrapper">
	...
	<s:url var="listAudited" action="listAudited" namespace="/item" />
	<sjg:grid dataType="json" href="%{listAudited}" pager="true"
		...
		rowList="10,15,20" rowNum="10" viewrecords="true" height="380"
