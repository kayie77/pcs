...
$(document).ready(function() {
	...
	$.subscribe('updateItemComplete', function(event,data) {
     ...
     //明细
	  $.subscribe('editItemDetail', function(event,data) {
	   ...
	   $.subscribe('addDetail', function(event,data) {
		   var rowId = jQuery("#itemTable").jqGrid('getGridParam','selrow');
     ...
     $.subscribe('editFund', function(event,data) {
  	    var rowId = jQuery("#"+data.id).jqGrid('getGridParam','selrow');
  	    var itemId = jQuery("#itemTable").jqGrid('getGridParam','selrow');
  	    if(rowId){
...
<div class="app-panel">
	<div class="title">当前位置：采购计划 &gt;&gt; 项目管理</div>
	<div class="toolbar">
		<sj:a onClickTopics="addItem" button="true" buttonIcon="ui-icon-plus">
...
<s:url var="itemTypeSelect" action="select" namespace="/base/dictionary">
...
<sjg:grid id="itemTable" dataType="json" href="%{listAdmin}"
