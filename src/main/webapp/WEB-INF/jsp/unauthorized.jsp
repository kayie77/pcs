...
<script type="text/javascript" src="${ctx}/resources/jquery/jquery-2.0.3.min.js"></script>
				...
				<div class="col-xs-6 col-md-4 text-left login-col">
		  		  	<div class="panel panel-primary">
		  		    	<div class="panel-heading">
		  		           	<h3 class="panel-title">系统错误</h3>
		  		   		</div>
		  				<div class="panel-body">
		    				<div class="tab-pane" id="normal-pane">
								...
								<div class="form-group">
							   		<div class="col-sm-offset-3 col-sm-8">
							    		<button type="button" class="btn btn-primary" id="submitLink"><spring:message code="global.return" /></button>
							   	    </div>
								</div>
		     		  		</div>
		   			  	</div>
